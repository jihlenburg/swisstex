...
\marg{Eine Signalfarbe: \code{band} folgt \code{accent}}
...
-- in der Signalfarbe, und rechts den mit \code{\textbackslash
setrunningtitle} gesetzten Lauftitel in der Schmalschrift auf
...
trägt sie eine Marke. Und weil die Marke in der Marginalspalte steht und ein
...
die Satzoberkante (A2), rechte Satzkante (A3), Marginalspalte und Bund (A4),
Legendenflucht der Tabellen (A5), Überschriften am Seitenfuss (A6), die beiden
Zonen der Marginalspalte (A7), Zeilenanfänge ohne Einzug (A8) sowie die Flucht
der Abbildungslegende mit der Abbildungsoberkante (A9). Die Kennzahlen lassen
...
der Kolumnentitel mit der Pagina im Grundschriftgrad, ihrer Grundlinie auf
der verlängerten Rasterzeile und einer bildfreien Kopfzone (A11), der
Umschlag mit dem Farbband auf Rasterzeilen, Schriftgraden aus der
Anzeigenskala und der Verankerung des Überformatzeichens (A12,
Abschnitt~\ref{sec:umschlag}), die
Kommensurabilität des Nebentext-Durchschusses (A13), die Farbrollen (A15),
das Schriftinventar der eingebetteten Schriften gegen die deklarierten
...
Fliesstext daneben; swisscheck A17 hält den Zustand fest (kein Glossenblock
